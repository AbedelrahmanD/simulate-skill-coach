...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Voice-first AI mock interviews. HR, technical, and grill modes with a natural human-sounding interviewer." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "MockMate — Autonomous Interview Simulator" },
      { property: "og:description", content: "Practice interviews with a natural-voice AI. Runs privately in your browser." },
